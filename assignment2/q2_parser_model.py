...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        embeddings = tf.reshape(\
            features, [-1, n_features * embed_size], name='embeddings')
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        W  = xavier_initializer([n_features * embed_size, hidden_size], name='W')
        U  = xavier_initializer([hidden_size, n_classes], name='U')
        b1 = tf.Variable(tf.zeros([1, hidden_size], tf.float32), name='b1')
        b2 = tf.Variable(tf.zeros([1, n_classes], tf.float32), name='b2')
